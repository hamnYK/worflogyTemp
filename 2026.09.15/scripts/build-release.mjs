...
const files=['index.html','en.html','nia-ontology-workshop-with-worflogy.html','robots.txt','sitemap.xml','CNAME','.nojekyll','lib/phaser.min.js','lib/mammoth.browser.min.js','lib/vis-network.min.js','lib/workshop-safety.js','lib/PHASER-LICENSE.txt'];
