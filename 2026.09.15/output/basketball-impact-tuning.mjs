...
for(const tilt of [.12,.3,.5,.7])for(const friction of [.16,.32,.5]){
 const text=source.replace('friction:.32','friction:'+friction).replace('Math.PI/2,0,.12','Math.PI/2,0,'+tilt).replace('1.5,10+power,2','1.5,4+power*.35,2').replace('angularDamping:.045','angularDamping:.018');
