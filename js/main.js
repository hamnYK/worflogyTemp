...
function initGraph() {
  ...
  const nodes = [
    ...
    { id: 'p1', label: '팀 지식\n자산화', sublabel: '업무 연속성 100%', href: 'project-1.html',
      x: cx, y: cy - R, r: 64 },
    { id: 'p2', label: '전략적 피봇\n& 문제 진단', sublabel: '리스크 관리', href: 'project-2.html',
      x: cx + R, y: cy, r: 64 },
    { id: 'p3', label: '연구 및\n핵심 IP 보호', sublabel: '암묵지 형식지화', href: 'project-3.html',
      x: cx, y: cy + R, r: 64 },
    { id: 'p4', label: '지능형\n내러티브 엔진', sublabel: '서사적 전략 운영', href: 'project-4.html',
      x: cx - R, y: cy, r: 64 },
  ];
