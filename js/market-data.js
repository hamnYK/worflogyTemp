...
const marketData = {
  ...
  marketSize: {
    ...
    global: {
      ...
      tam: {
        value: "20억 ~ 60억",
        label: "TAM (전체시장)",
        desc: "글로벌 지식 그래프(Knowledge Graph) 및 AI 기반 비즈니스 시뮬레이션/지식 자동화 솔루션 시장 총합 (2032년 약 37억 달러 규모로 고성장 전망)"
      },
      sam: {
        value: "3억 ~ 10억",
        label: "SAM (유효시장)",
        desc: "스타트업 역량 진단, 시나리오 시뮬레이션 및 데이터 기반 보고서 도구를 도입하려는 글로벌 테크 기업 및 전문 경영 컨설팅 도메인"
      },
      som: {
        value: "50만 ~ 5,000만",
        label: "SOM (수익시장)",
        desc: "글로벌 AC/VC 파트너십 네트워크 및 대표자 보유 글로벌 리스크 관리 협회(180개국 네트워크) 채널을 통해 우선 도달할 수 있는 타깃 시장"
      }
    }
  },
  ...
  growthRate: {
    ...
    desc: "글로벌 기업 진단 및 의사결정 도메인 내 AI 활용 시장의 연평균 성장률(CAGR)"
  },
  ...
  milestones: [
    ...
    },
    {
      ...
      desc: "정부 주도 R&D 지원사업 참여를 위한 컨소시엄을 구성하고, 신규 서사 게임 엔진 솔루션 개발 착수 및 B2B 마케팅/협업 채널을 다각화합니다."
    },
    {
      period: "2026년 하반기",
