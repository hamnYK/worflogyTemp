...
- <a href="#" id="start-demo-link">데모 링크</a><br>- 2025.10.23 기술 스택 검증<br>- 2025.10.24 IF·BM·DB 개발·테스트 환경 설정<br>- 2025.10.25 데모 UI (Contexton) 1차 완료<br>- 2025.11.23 데모 핵심 프로세스 기본 구현 완료<br>- 2025.11.23 로컬 특화 LLM 연구개발 중<br>- 2025.12.02 UX 요소 기능 추가<br>- 2026.02.04 스타트업 PoC 데모 컨설팅 CloseBeta<br>- 2026.02.04 멀티 클라이언트 지원 온톨로지 엔진 개발 중<br>- 2026.02.14 멀티 클라이언트 지원 온톨로지 v.1 PoC 준비 중<br>- 現 고도화 진행 중: 멀티 AI 에이전트 지원 온톨로지 엔진<br>- 現 고도화 진행 중: 컨텍스트 RAG 온톨로지 엔진<br>- 現 고도화 진행 중: 컨텍스트 RAG 온톨로지 게임 엔진
...
![Overall System](/demo/1.%20Overall%20System%20P1.png)
