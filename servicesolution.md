...
### 고객 니즈(Needs)와 솔루션
> - **GRC(Governance, Risk and Compliance) 및 내부 감사**: 기업 데이터에 대해 전문가적 해석에 따른 기존의 정책 준수 리스크를 **Human-factor에 의한 불확실성을 추적**함으로써 완화할 수 있습니다.
> - **생명공학 및 신소재 연구개발**: 실증 및 경험 연구(Empirical Study) 중심의 도메인 영역에서 연구원들은 **의사결정 과정을 구조화**함으로써 가설에서 결과를 효율적으로 빌드업 할 수 있습니다.
> - **워플로지(WORFLOGY) 가치**: **의사결정 과정에서 구조화된 워크플로 그래프를 생성**하는 솔루션을 제공합니다. 
